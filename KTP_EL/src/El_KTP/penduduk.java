...
//    ArrayList<String> jenKel = new ArrayList<String>();
//    ArrayList<String> golDarah = new ArrayList<String>();
//    ArrayList<String> rt = new ArrayList<String>();
//    ArrayList<String> desa = new ArrayList<String>();
//    ArrayList<String> agama = new ArrayList<String>();
//    ArrayList<String> statusK = new ArrayList<String>();
//    ArrayList<String> pekerjaan = new ArrayList<String>();
